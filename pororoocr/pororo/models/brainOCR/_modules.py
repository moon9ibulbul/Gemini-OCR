...
# Compat shim untuk torchvision baru yang tidak punya model_urls
try:
    from torchvision.models.vgg import model_urls  # torchvision lama
except Exception:
    # torchvision baru: tambahkan stub minimal agar kode lama tetap jalan
    model_urls = {
